...
from baselines.run import parse_cmdline_kwargs, build_env, configure_logger, get_env_type,get_default_network
...
def train(args,extra_args):
    ...
    env = build_env(args,normalize_ob=True,normalize_ret=False)
