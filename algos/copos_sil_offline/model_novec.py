...
class Model(object):
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train,
                 ...
                 sil_value=0.01, sil_alpha=0.6, sil_beta=0.1, sil_loss=0.1,
                 mpi_rank_weight=1, comm=None, microbatch_size=None,ppo=True,prev_pi=None,silm=None):
        ...
        self.sil=SelfImitation(self.pi.X, self.pi.vf,
                                 self.pi.pd.entropy(), None,
                                 self.pi.pd.neglogp,
                                 ac_space, fn_reward=fn_reward, fn_obs=fn_obs,
                                 n_env=nbatch_act, n_update=sil_update,
                                 w_value=sil_value,
