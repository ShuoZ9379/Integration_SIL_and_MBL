...
logdir = '/work/scratch/sz52cacy/logs-trial-on-noobnorm-nofix/'
...
python /work/scratch/sz52cacy/Desktop/carla_sample_efficient/plt/command_online_ori.py --num_timesteps=""" + num_timesteps + """ --seeds=1 --st_seed=""" + str(trial) + """ --alg=""" + algo_names[k] + """ --env=""" + env_name + """ --argu=""" + argus[k] + """\
    """
