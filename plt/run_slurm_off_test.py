...
Command
    python3 run_slurm_off_test.py <TIME_LIMIT> <NUM_TIMESTEPS> <N_TRIALS> <ST_TIAL> <ENV_LIST>
Example
    python3 run_slurm_off_test.py 24:00:00 5e4 2 0 HalfCheetah-v2 Ant-v2
...
conda activate cse
python ~/Desktop/carla_sample_efficient/plt/command_offline_alg_lgd_test.py --num_timesteps=""" + num_timesteps + """ --seeds=1 --st_seed=""" + str(trial) + """ --alg=""" + alg_name + """ --env=""" + env_name + """ --time=""" + time_limit + """\
    """
