...
Command
    python3 run_slurm_off_work.py <TIME_LIMIT> <NUM_TIMESTEPS> <N_TRIALS> <ST_TIAL> <ENV_LIST>
Example
    python3 run_slurm_off_work.py 24:00:00 5e6 10 0 HalfCheetah-v2 Ant-v2 Reacher-v2 Swimmer-v2
    python3 run_slurm_off_work.py 24:00:00 4.2e5 10 0 HalfCheetah-v2
...
/work/scratch/sz52cacy/Desktop/logs/xxx/Pendulum-v0/mbl+copos_0/
/work/scratch/sz52cacy/Desktop/logs/xxx/Pendulum-v0/mbl+copos_1/
...
Additionally, stdout and stderr are flushed to log files. For example
/work/scratch/sz52cacy/logs-trialxxx/Pendumlum-v0/stdout_mbl_copos_0
/work/scratch/sz52cacy/logs-trialxxx/Pendumlum-v0/stderr_mbl_copos_0
...
...
python /work/scratch/sz52cacy/Desktop/carla_sample_efficient/plt/command_offline_alg_lgd_work.py --num_timesteps=""" + num_timesteps + """ --seeds=1 --st_seed=""" + str(trial) + """ --alg=""" + alg_name + """ --env=""" + env_name + """ --time=""" + time_limit + """\
    """
