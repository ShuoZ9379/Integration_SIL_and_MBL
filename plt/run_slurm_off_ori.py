...
logdir = '/work/scratch/sz52cacy/logs-trial-off' # directory to save log files (where stdout is flushed)
...
python /work/scratch/sz52cacy/Desktop/carla_sample_efficient/plt/command_offline_alg_lgd_ori.py --num_timesteps=""" + num_timesteps + """ --seeds=1 --st_seed=""" + str(trial) + """ --alg=""" + alg_name + """ --env=""" + env_name + """ --time=""" + time_limit + """\
    """
