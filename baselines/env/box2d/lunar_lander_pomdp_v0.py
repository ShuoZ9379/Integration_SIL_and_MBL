...
#####################################################
######Partial Obersavable Continuous LunarLander#####
#####################################################
...
class LunarLanderPOMDPv0(gym.Env):
    metadata = {
    ...
    def step(self, action):
        ...
        px = (pos.x - VIEWPORT_W/SCALE/2) / (VIEWPORT_W/SCALE/2)
        py = (pos.y - (self.helipad_y+LEG_DOWN/SCALE)) / (VIEWPORT_W/SCALE/2)
        state = [
            px,
            py,
    ...
    def render(self, mode='human'):
        ...
        # for noise area
        self.viewer.draw_polygon(self.block_polys, color=(92/255, 102/255 , 89/255))
...
class LunarLanderContinuousPOMDPv0(LunarLanderPOMDPv0):
    continuous = True
...
if __name__=="__main__":
    #env = LunarLander()
    env = LunarLanderContinuousPOMDPv0()
    s = env.reset()
    total_reward = 0
    steps = 0
    while True:
